                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Inventory Material</li>
                        </ol>
                        <div class="row">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$keterangan;?></td>
                                            <td>
                                                <button type="button" class="btn btn-sm btn-warning mb-3" data-bs-toggle="modal" data-bs-target="#edit<?=$idm;?>">
                                                  Edit
                                                </button>
                                                <input type="hidden" name="idbarangyangmaudihapus" value="<?=$idb;?>">
                                                <button type="button" class="btn btn-sm btn-danger mb-3" data-bs-toggle="modal" data-bs-target="#delete<?=$idm;?>">
                                                  Delete
                                                </button>
                                            </td>                                           
                                        </tr>
                                          ...
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                ...
                                                <input type="hidden" value="<?=$idm;?>" name="idm">                                                
                                                <button class="btn btn-sm btn-primary" type="submit" name="updatebarangmasuk">Submit</button>
                                              </div>
                                            </form>
                                          ...
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                ...
                                                <button class="btn btn-sm btn-danger" type="submit" name="hapusbarangmasuk">Delete</button>
                                              </div>
                                            </form>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <br>
                <input type="text" name="penerima" placeholder="Remark" class="form-control" required>
                <br>
                <button class="btn btn-sm btn-primary" type="submit" name="barangmasuk">Submit</button>
              </div>
            </form>
